...
import {
  ...
  RowForm,
  RowFormGroup,
} from "../testamentowy-wniosek-o-stwierdzenie-nabycia-praw-do-spadku";
  ...
  return (
    <>
      <div className="text-4xl mb-0 mt-0 w-auto text-right flex justify-start text-gray-700 items-center">
        ...
        >
          <Icon icon="cross" size={33} className="mr-2" />
          <h1 className="text-4xl">ODRZUĆ SPADEK</h1>
        </div>
      </div>
      ...
      {loaded ? (
        <Formik
          onSubmit={(values) => {
            ...
            router.push(
              "/oswiadczenie-o-odrzuceniu-spadku/finalizacja?" +
